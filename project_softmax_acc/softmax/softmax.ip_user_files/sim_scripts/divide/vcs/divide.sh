...
# executing this script. Please type 'divide.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key divide_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc divide_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../softmax.srcs/sources_1/ip/divide/sim/divide.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.divide -o divide_simv
}
...
simulate()
{
  ...
  ./divide_simv $opts -do simulate.do
}
# Script usage
usage()
{
