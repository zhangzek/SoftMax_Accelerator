...
HD_PWD='D:/Project/verilog_pro/softmax/prj1/softmax/softmax.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log softmax.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source softmax.tcl -notrace
