The following files were generated for 'floating_point_1' in directory
...
Generate XCO file:
   ...
   * floating_point_1.xco

C Simulation Generator:
   Please see the core data sheet.

   * floating_point_1/cmodel/floating_point_v6_1_bitacc_cmodel_lin.zip
   * floating_point_1/cmodel/floating_point_v6_1_bitacc_cmodel_lin64.zip
   * floating_point_1/cmodel/floating_point_v6_1_bitacc_cmodel_nt.zip
   * floating_point_1/cmodel/floating_point_v6_1_bitacc_cmodel_nt64.zip

Generate EJava outputs:
   Please see the core data sheet.

   * demo_tb/tb_floating_point_1.vhd

Generate Implementation Netlist:
   Binary Xilinx implementation netlist files containing the information
   required to implement the module in a Xilinx (R) FPGA.

   * floating_point_1.ngc
...
Deliver IP Symbol:
   ...
   * floating_point_1.asy

SYM file generator:
   Generate a SYM file for compatibility with legacy flows

   * floating_point_1.sym
...
Generate ISE project file:
   ...
   * floating_point_1.gise
   * floating_point_1.xise

Deliver Readme:
   Readme file for the IP.

   * floating_point_1_readme.txt

Generate FLIST file:
   Text file listing all of the output files produced when a customized core was
   generated in the CORE Generator.

   * floating_point_1_flist.txt
